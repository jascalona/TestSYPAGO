...
public class StatusReportTranOTP {

        public static String StatusOTP(String token, String apiURL) throws Exception{
        ...
        public static void main(String [] args){
            ...
            try{
                ...
                String response = StatusOTP(Token, urlAPI);
